...
for j in range(1, rounds+1):
     for i in range(0, classes*len_classes):
         ...
         if i < 10:
             cv2.imwrite("P:/MQP_data/" + str(configuration) + "/" + str(subject) + "/image_" + str(j) + "_00" + str(i) + ".png", image)
         elif i >= 10 and i < 100:
             cv2.imwrite("P:/MQP_data/" + str(configuration) + "/" + str(subject) + "/image_" + str(j) + "_0" + str(i) + ".png", image)
         else:
             cv2.imwrite("P:/MQP_data/" + str(configuration) + "/" + str(subject) + "/image_" + str(j) + "_" + str(i) + ".png", image)
